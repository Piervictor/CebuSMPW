...
-- =============================================
-- Shifts Table
-- Concrete shift instances for a specific date,
-- derived from timeslot templates
-- =============================================
...
create table if not exists shifts (
  ...
  created_at timestamptz default now(),
  -- Prevent duplicate shifts for same location + date + time
...
-- One row per member assigned to a shift
